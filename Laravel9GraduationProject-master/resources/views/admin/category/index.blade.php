            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <a class="btn btn-primary btn-warning" href="{{route('admin.category.create')}}" style="width:400px" role="button">Add Category</a>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($data as $rs)
                                    <tr>
                                        ...
                                        <td><a href="{{route('admin.category.show',['id'=>$rs->id])}}" class="btn btn-info btn-sm">Show</a></td>
                                    </tr>
                                @endforeach
